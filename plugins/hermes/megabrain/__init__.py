...
try:
    from .megabrain_client import (  # noqa: E402
        MegaBrainClient, MegaBrainError, MegaBrainUnavailable)
    from .outbox import Outbox  # noqa: E402
    from .sender import Sender  # noqa: E402
    from . import mb_events as E  # noqa: E402
except ImportError:  # flat vendored plugin loaded by Hermes
    from megabrain_client import (  # noqa: E402
        MegaBrainClient, MegaBrainError, MegaBrainUnavailable)
    from outbox import Outbox  # noqa: E402
    from sender import Sender  # noqa: E402
    import mb_events as E  # noqa: E402

try:
    from agent.memory_provider import MemoryProvider, RecallStatus, is_trivial_prompt  # noqa: E402
...
def classify_memory_intent(query: str) -> Optional[str]:
...
def _explicit_directive(text: str) -> Optional[tuple[str, str, str]]:
...
class MegaBrainProvider(MemoryProvider):
    ...
    def __init__(self):
        self._client: Optional[MegaBrainClient] = None
    ...
    def _enqueue(self, event: dict) -> None:
        ...
        try:
            ...
            pass  # never break a turn on outbox failure
...
def _derive_tool_events(session_id: str, messages: List[Dict[str, Any]],
                        project_id: Optional[str], channel: str) -> List[dict]:
