...
class MegaBrainClient:
    ...
    def resolve_project(self, project_id: Optional[str] = None,
    ...
    def get_context(self, project_id: Optional[str] = None,
                    session_id: Optional[str] = None,
                    query: Optional[str] = None,
                    token_budget: Optional[int] = None,
                    since_revision: Optional[int] = None) -> dict:
        return self._request("POST", "/v1/memory/context", {
            "project_id": project_id, "session_id": session_id, "query": query,
            "token_budget": token_budget, "since_revision": since_revision})

    def memory_search(self, query: str, project_id: Optional[str] = None,
                      session_id: Optional[str] = None,
                      mode: Optional[str] = None, limit: int = 10,
                      at_time: Optional[str] = None) -> dict:
    ...
    def search_events(self, q: Optional[str] = None,
                      session_id: Optional[str] = None,
                      project_id: Optional[str] = None,
                      event_type: Optional[str] = None,
                      source: Optional[str] = None, limit: int = 50) -> dict:
        params = []
        if q:
